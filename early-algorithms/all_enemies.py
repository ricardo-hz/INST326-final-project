...
necromancer = Enemy("Necromancer", 200, 40, 650, 25, "Boss", AbilityList(basic_attack4))
death_knight = Enemy("Death Knight", 75, 60, 800, 45, "Boss", AbilityList(basic_attack1))
necromancer_party = Enemy_Party("The Damned", [necromancer, death_knight])

elf_king = Enemy("Elf King", 125, 65, 750, 100, "Boss", AbilityList([basic_attack5]))
