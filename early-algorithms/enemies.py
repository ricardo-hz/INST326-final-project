...
wolf_pack = Enemy_Party("Wolf Pack", wolves, "WOOF WOOF WOOF!")
...
cult = Enemy_Party("Cult of the Forgotten", cultists, "PREPARE FOR THE WRATH OF THE UNKNOWN")
...
bandit_group = Enemy_Party("Sunset Mountain Bandits", bandits, 
                           "EVEN DURING THE APOCALYPSE, WE STILL ROB PEOPLE")
...
orc_tribe = Enemy_Party("Orsinium Orc Tribe", orcs, 
                        "WE ARE THE STRONGEST, WE LIVE FOR THE THRILL OF BATTLE")
...
minotaur_party = Enemy_Party("The Minotaur", [minotaur], 
                             "Give me a challenge! Fight until you can no longer...")
...
necromancer_party = Enemy_Party("The Damned", [necromancer, death_knight],
                                "We desire the Souls of you Heroes to learn how to live again...")

elf_king = Enemy("Elf King", 125, 65, 750, 100, "Boss")
erlkonig_party = Enemy_Party("Erlkonig", [elf_king], "There is only one fate, your deaths...")
